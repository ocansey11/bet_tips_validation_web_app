...
from app.scraping import standings_scrapper, cls_table_name, pls_table_name, url_sofascore,sofascore_className, user,password,host,port,dbname 
...
def previous():
    try:
        standings_scrapper(pls_table_name,url_sofascore,sofascore_className, user,password,host,port,dbname )
